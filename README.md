...
Run `ng serve` for a dev server. Navigate to `https://i4q-dev.ikap.biba.uni-bremen.de`. The app will automatically reload if you change any of the source files.
