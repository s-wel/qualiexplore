...
export class ApiService {
  ...
  // JSON-SERVER API to edit the tree
    getEditData(){
      return this.http.get("http://i4q-dev.ikap.biba.uni-bremen.de:3000/edit"); 
    }
    deleteEditData(data){
      return this.http.delete("http://i4q-dev.ikap.biba.uni-bremen.de:3000/edit/"+data);
    }
    updateEditData(data: object,  id : number){
      return this.http.put("http://i4q-dev.ikap.biba.uni-bremen.de:3000/edit/"+id, data);
    }

  //JSON-SERVER API for Factors Data using TreeView
    getFactorsData(){
      return this.http.get("http://i4q-dev.ikap.biba.uni-bremen.de:3000/factors"); 
    }
    postFactorsData(data: any){
      return this.http.post("http://i4q-dev.ikap.biba.uni-bremen.de:3000/factors", data);
    }
    updateFactorsData(data: object,  id : number){
      return this.http.put("http://i4q-dev.ikap.biba.uni-bremen.de:3000/factors/"+id, data);
    }
